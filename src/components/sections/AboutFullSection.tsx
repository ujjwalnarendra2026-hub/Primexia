  ...
  <div className="h-full flex items-center justify-center px-6 md:px-10">
    <div className="max-w-4xl w-full mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
        {[
          { title: "Our Philosophy", text: "We operate at the intersection of creative enterprise and institutional discipline. Every business is expected to demonstrate operational clarity and sustainable economics." },
          { title: "Leadership", text: "Our team brings experience from finance, technology, creative industries, and infrastructure. We are operators first — capital allocation is informed by execution reality." },
          { title: "Long-Term Outlook", text: "We measure outcomes in years, not quarters. Patience in investment and operations is our competitive advantage in short-term-driven markets." },
        ].map((item, i) => (
          <AnimatedParagraph key={item.title} delay={0.35 + i * 0.1}>
